...
window.rop = function () {
  ...
  this.finalizeSymbolic = function (idx, val) {
    if (val instanceof int64) {
      this.stack_array[stack_reserved_idx + idx * 3] = val.low;
      this.stack_array[stack_reserved_idx + idx * 23 + 1] = val.hi;
    } else {
      this.stack_array[stack_reserved_idx + idx * 3] = val;
      this.stack_array[stack_reserved_idx + idx * 3 + 1] = 0;
    }
  }
